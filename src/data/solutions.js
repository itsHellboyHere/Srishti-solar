...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    desc:      '5 kW से 10 kW+ तक। बिजली की लागत 80% तक कम करें। 3–5 साल में पूरा निवेश वापस। इंजीनियर की निगरानी में इंस्टॉलेशन।',
    descEn:    '5kW to 10kW+. Reduce electricity cost by 80%. Full ROI in 3–5 years. Installation supervised by engineer.',
    ...
    benefits: [
      ...
      { iconKey: 'hard-hat', icon: '🏭', hi: 'इंजीनियर की निगरानी',en: 'Supervised by Best engineers' },
  ...
  },
  {
    ...
    image:     'https://res.cloudinary.com/dgifa4wgb/image/upload/f_auto,q_auto,w_1200/v1777273584/ChatGPT_Image_Apr_27_2026_at_12_35_57_PM_zx6itb.png',
    tag:       'Bihar Villages',
  ...
  },
  {
    ...
    desc:      'केंद्र सरकार की योजना — ₹78,000 तक सीधे बैंक में। Srishti Solar Power ने अब तक ₹7,41,00,000 की सब्सिडी दिलाई है। हम पूरी process करते हैं।',
    descEn:    "Central govt scheme — up to ₹78,000 directly in bank. Srishti Solar has helped customers get ₹7,41,00,000 in subsidies. We handle the full process.",
    sizes:     ['1 kW', '2 kW', '3 kW'],
    subsidy:   '₹78,000 direct bank',
    subsidyEn: '₹78,000 direct to bank',
    savingsHi: '₹7,41,00,000 सब्सिडी दिलाई',
    savingsEn: '₹7,41,00,000 subsidy assisted',
    benefits: [
    ...
    image:     'https://res.cloudinary.com/dgifa4wgb/image/upload/f_auto,q_auto,w_1200/v1777273584/9eb3c1a3-68e6-43d5-b525-b14826cd977c_isxpcb.png',
    tag:       'सरकारी योजना',
    tagEn:     'Govt Scheme',
    color:     '#F4A300',
  },
...
export const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    descHi:  'DAKASH इंजीनियर आपकी ज़रूरत के अनुसार सिस्टम डिज़ाइन करते हैं — MNRE मानकों के अनुसार।',
    descEn:  'DAKASH engineer designs system per your need — as per MNRE specifications.',
    iconKey: 'pen-tool',
    icon:    '📐',
    time:    '2–3 दिन',
    timeEn:  '2–3 days',
