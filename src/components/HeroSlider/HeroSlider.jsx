  ...
  },
{
    ...
    desc: '1kW → ₹30,000 · 2kW → ₹60,000 · 3kW → ₹78,000 सीधे बैंक में। SBPDCL / NBPDCL से पंजीकृत · MNRE के नियम अनुसार कार्य।',
  ...
  {
    tag: 'An MNRE, NBPDCL & SBPDCL Empanelled Vendor',
    lines: ['Srishti Solar Power'],
    accent: 'से सोलर लगवाएँ।',
    desc: 'सृष्टि सोलर पावर — भरोसेमंद सोलर समाधान\n\nसोलर प्लांट के लिए समर्पित सेवा — अब कहीं से भी अपने सोलर सिस्टम को मॉनिटर और कंट्रोल करें।',
