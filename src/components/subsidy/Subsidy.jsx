...
const STRENGTHS = [
  { en: 'N-Type Topcon Advanced Panel',      hi: 'टॉपकॉन N-Type टॉपकोट पैनल',   icon: '◈' },
  { en: 'HDG Steel Structure (2S ≥ Grade)',  hi: 'HDG कोटेड स्टील संरचना',        icon: '◈' },
  { en: 'SS Nut Bolts & Fasteners',          hi: 'स्टेनलेस स्टील नट-बोल्ट',       icon: '◈' },
  { en: 'Tier 1 Inverter',                   hi: 'टियर-1 इन्वर्टर',               icon: '◈' },
  { en: 'Copper Wire',                       hi: 'कॉपर वायरिंग',                  icon: '◈' },
    ...
    <section className={styles.section} ref={sectionRef}>
      ...
      <div className={styles.floaters} aria-hidden="true">
        {SOLAR_FLOATERS.map((f, i) => (
          <span key={i} className={styles.floater} style={{
            '--fl-left': f.left, '--fl-top': f.top, '--fl-size': f.size,
            '--fl-dur': f.dur, '--fl-delay': f.delay, '--fl-drift': f.drift,
          }}>
      ...
      <div className={styles.waveBottom} aria-hidden="true">
        <svg viewBox="0 0 1440 90" preserveAspectRatio="none" width="100%" height="100%">
          ...
          <path d="M0,0 Q720,90 1440,0 L1440,90 L0,90 Z" fill="url(#waveLinear)" />
          <path d="M0,0 Q720,90 1440,0 L1440,90 L0,90 Z" fill="url(#waveRadial)" />
        </svg>
      </div>
